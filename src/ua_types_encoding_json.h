...
(*encodeJsonSignature)(const void *UA_RESTRICT src, const UA_DataType *type,
                       CtxJson *UA_RESTRICT ctx);

typedef UA_StatusCode
(*calcSizeJsonSignature)(const void *UA_RESTRICT src, const UA_DataType *type,
                         CtxJson *UA_RESTRICT ctx);

typedef UA_StatusCode
(*decodeJsonSignature)(void *UA_RESTRICT dst, const UA_DataType *type,
                       CtxJson *UA_RESTRICT ctx, ParseCtx *parseCtx,
