...
START_TEST(UA_VariableAttributes_json_encode) {
    ...
    UA_VariableAttributes src = UA_VariableAttributes_default;
    ...
    src.accessLevel = UA_ACCESSLEVELMASK_READ | UA_ACCESSLEVELMASK_WRITE;
...
START_TEST(UA_Int32_Min_json_decode) {
    ...
    ck_assert_int_eq(*((UA_Int32*)out.data), -2147483648);
